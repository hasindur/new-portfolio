...
function Header() {
    ...
    return (
        ...
        <header className='bg-glass-100 flex justify-between items-center py-2 px-2 lg:px-5 '>
            ...
            <button className="hidden md:block text-amber-50 text-base bg-purple-600 px-4 py-2 rounded-3xl cursor-pointer tracking-wider transition-colors hover:text-black z-50">Sign In</button>
